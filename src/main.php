    ...
    <div class="wrapper">
        <div class="wrap_first_line">
            <div class="main_left_link">
                <div class="logo_wrap_main">
                    <a href="/" class="logo__link_black"></a>
                    <div class="logo_text">Медиапространство<br>рекламы</div>
                </div>

                <div class="select_lang">
                    <a href="#" class="select_lang__link">En</a>
                    <a href="#" class="select_lang__link active">Ru</a>
                </div>
            </div>

            <div class="right_link">
                <div class="nav-link__head">
                    <a href="#" class="run_project color_red">Начать проект</a>
    ...
    <div class="wrapper">
        <div class="wrap_logo_center">
            <div class="logo_center">
                ...
                <div class="white_dashed_circle"></div>
            </div>

            <div class="wrap_eye">
                <div class="wrap_border_dashed">
                    <div id="eye">
                        <div id="pupil">
                            <div id="dot"></div>
                        </div>
